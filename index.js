...
if (program.verbose) console.log(program.opts())

console.log(yellow(require("figlet").textSync('Meetusic Bot', {
    font: 'Standard',
...
;(async () => {
    ...
    let domain = url.parse(page.url()).host

    if (domain === "apps.google.com") {
        ...
        await page.keyboard.type(program.email)
    ...
    await page.keyboard.type("Hello! I'm Meetusic Bot, a bot that helps you play music from online sources. type \"@meetusicbot /help\" (without quotes) to see what I can do")
    await shiftEnter()
